...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_whatsapp_call_permissions_id", "whatsapp_call_permissions", ["id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index("ix_whatsapp_call_permissions_recipient_phone_number", table_name="whatsapp_call_permissions")
    op.drop_index("ix_whatsapp_call_permissions_phone_number_id", table_name="whatsapp_call_permissions")
    op.drop_index("ix_whatsapp_call_permissions_telephony_configuration_id", table_name="whatsapp_call_permissions")
    op.drop_index("ix_whatsapp_call_permissions_organization_id", table_name="whatsapp_call_permissions")
    op.drop_index("ix_whatsapp_call_permissions_id", table_name="whatsapp_call_permissions")
